...
--1.REGISTROS UNICOS: ¿Cuál es la cantidad total de registros unicos en la tabla de ordenes? 
--(informacion localizada: INSIGHT VENTAS)
SELECT COUNT (id_orden) as 'totalorden'
FROM Ordenes;

--2.EMPLEADOS POR DEPARTAMENTO: ¿Cuántos empleados existen en cada departamento?
...
--3.PRODUCTOS POR CATEGORIA: ¿Cuántos productos hay por codigo de categoria?
...
--4.IMPORTACION DE CLIENTES: ¿Cuántos clientes se han importado a la tabla de clientes?
--(informacion localizada: INSIGHT VENTAS)
SELECT COUNT (id_clientes) as 'totalclientes'
FROM Clientes;

/*5.ANALISIS DE DESEMPEÑO DE SUCURSALES: ¿Cuáles son las sucursales con un promedio de facturacion/ingresos
